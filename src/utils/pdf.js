...
function generateHeader(doc) {
  doc
    .image("logoProject-1.png", 50, 45, { width: 50 })
    .fillColor("#444444")
    .fontSize(20)
    .text("E-commerce Invoice.", 110, 57)
    .fontSize(10)
    .text("A.A", 200, 50, { align: "right" })
    .text("123 Main Street", 200, 65, { align: "right" })
    .text("El-Bhaira, Damnhor, 10025", 200, 80, { align: "right" })
    .moveDown();
}
...
function generateCustomerInformation(doc, invoice) {
  ...
  doc
    ...
    .text(invoice.shipping.phone, 350, customerInformationTop + 30)
...
function generateInvoiceTable(doc, invoice) {
  ...
  doc.font("Helvetica-Bold");
  generateTableRow(doc, duePosition, "", "", "Balance Due", "", formatCurrency(invoice.paid));
  doc.font("Helvetica");
}
